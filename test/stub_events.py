...
print('after rating ' + item_ids[1] + ' rating ' + ratings[1] + s2.json())
...
print('after rating ' + item_ids[2] + ' rating ' + ratings[2] + s3.json())
...
print('after rating ' + item_ids[3] + ' rating ' + ratings[3] + s4.json())
